...
<html lang="en">
    ...
    ?>
		...
		<p>Welcome to Donation Dome!
			Here, you can choose to leave us a donation!</p>
		<p>Hopefully you are feeling generous after becoming mindful!</p>
		<div id = "halfCircle">
		...
		<center>
		Enter your information into the donation form.
		</center>
	...
	if(isset($_COOKIE["user"])){
		...
		echo "<br><h2>Please login to make a donation.</h2><br>";
	}
	...
	function donationForm() {
		...
		<form class = 'rows' method = 'post' action = '$script'>
			...
			<input type ='submit' id = "submit" name ='page' value = 'Enter' />
