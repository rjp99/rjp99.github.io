            ...
            <form action='contact.php' method='post'>
                <table id = "form">
                    <tr>
                        ...
                        <td><input name = "name" type = "text" id = "name" size = "22" /><span class='error'>* <?php echo $nameErr; ?></span></td>
                    </tr>
                    <tr>
                        <td><label>Email Address: </label></td>
                        <td><input name = "email" type = "text" id = "email" size = "22" /><span class='error'>* <?php echo $emailErr; ?></span></td>
                    <tr>
